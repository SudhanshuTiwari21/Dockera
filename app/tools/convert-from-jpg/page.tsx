...
export const metadata: Metadata = {
  ...getDefaultMetadata({
    title: "Convert from JPG Online – JPG to PNG, GIF",
    description:
      "Turn JPG images to PNG and GIF. Choose several JPGs to create an animated GIF in seconds! Free, browser-based.",
