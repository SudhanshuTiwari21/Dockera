...
export const metadata: Metadata = {
  ...getDefaultMetadata({
    title: "Word to PDF Online – Convert DOC, DOCX to PDF",
    description:
      "Convert DOC or DOCX documents to PDF. Preserve layout and formatting. Free, browser-based.",
    ...
    <article className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
      <nav aria-label="Breadcrumb" className="mb-8">
        <ol className="flex flex-wrap items-center gap-2 text-sm text-slate-600 dark:text-slate-400">
          ...
          <li className="text-slate-900 dark:text-slate-100">Word to PDF</li>
        </ol>
      </nav>
      ...
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p className="mt-3 max-w-xl text-lg text-slate-600 dark:text-slate-400">
          Convert DOC or DOCX documents to PDF. Preserve layout and formatting.
        </p>
