...
export const metadata: Metadata = {
  ...getDefaultMetadata({
    title: "Merge PDF Online – Combine Multiple PDFs",
    description:
      "Combine multiple PDFs into one file. Reorder pages and merge in seconds. Free, browser-based.",
      ...
      <div className="flex flex-col items-center justify-center py-16 text-center">
        ...
        <div className="mt-8 rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 px-8 py-12">
          ...
          <p className="mt-2 text-slate-600 dark:text-slate-400">
            ...
            <Link href="/tools/pdf-compressor" className="font-medium text-slate-900 dark:text-slate-100 underline underline-offset-2 hover:no-underline">
              PDF Compressor
            </Link>{" "}
            meanwhile.
          </p>
